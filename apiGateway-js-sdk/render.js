...
function searchPhoto()
{
  ...
  var apigClient = apigClientFactory.newClient({
                     apiKey: "RAbQGlfiCt1Bdfphacz04348WPcYUnhs8ja4u89C"
        });
    ...
    apigClient.searchGet(params, body , additionalParams).then(function(res){
        ...
        resp_data.forEach( function(obj) {
            ...
            var img = new Image();
            img.src = "https://s3.amazonaws.com/photo1store/"+obj;
...
function uploadPhoto()
{
   ...
   var encoded_image = getBase64(file).then(
     ...
     var body = data;
     var params = {"object" : file.name, "folder" : "photo1store", "Content-Type" : file.type};
     var additionalParams = {};
     apigClient.uploadFolderObjectPut(params, body , additionalParams).then(function(res){
       if (res.status == 200)
       {
